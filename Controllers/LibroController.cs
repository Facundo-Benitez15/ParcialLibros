...
namespace ParcialLibros.Controllers
{
    public class LibroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Editorial")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Editorial")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
